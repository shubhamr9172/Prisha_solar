...
export default function AdminPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    // Verify TOTP. Standard code is generated by the user's authenticator.
    // For demo/validation, we allow 123456 or a valid dynamic verification.
    // In production we would verify against otpauth library on server.
    if (mfaCode.length === 6) {
      // In mock mode, we accept 123456 or 999999 as verification codes.
          ...
          <div style={{ width: '100%', maxWidth: '380px' }}>
            ...
            <form onSubmit={handleLogin}>
              <div className="form-group" style={{ textAlign: 'center', background: '#0b0f19', padding: '16px', borderRadius: '8px', marginBottom: '20px', border: '1px dashed #334155' }}>
                ...
                <span style={{ fontSize: '10px', color: '#64748b', display: 'block', marginTop: '6px' }}>Scan this secret to generate dynamic codes. (Use code: **123456** to log in)</span>
              </div>
